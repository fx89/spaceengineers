...
The development version of the script can be found here:
    https://github.com/fx89/spaceengineers/tree/main/UiFramework/ChaseLights
...
private static bool       TEXT_PANEL_1_MIRRORED     = false;                      // If the panel is placed in certain ways, it might have to be mirrored so that left is left and right is right
...
private static bool       TEXT_PANEL_2_MIRRORED     = false;                      // If the panel is placed in certain ways, it might have to be mirrored so that left is left and right is right
